        ...
        loop {
            match MachMessageReceiver::recv(self)? {
                ...
                Some(mach_msg) => {
                    ...
                    let credentials = get_credentials_from_message(&mach_msg)?;
...
pub fn get_current_process_credentials() -> io::Result<Credentials> {
...
pub fn get_credentials_from_message(message: &MachMessage<'_>) -> io::Result<Credentials> {
